...
import { Mail, Phone, Lock, User, MapPin, ArrowRight, AlertCircle, Sparkles, KeyRound } from 'lucide-react';
          ...
          {!isCreateAccount ? (
            ...
            <form onSubmit={handleLogin} className="space-y-4">
              ...
              <div className="pt-2 text-center">
                ...
                >
                  Create Account → new users ke liye
                </button>
              </div>
            ...
            <form onSubmit={handleCreateAccount} className="space-y-3">
              ...
              >
                <span>{loading ? 'Creating Account...' : 'Register & Open User Dashboard 🥪'}</span>
