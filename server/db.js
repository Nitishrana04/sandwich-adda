...
export function createOrder(data) {
  ...
  const newOrder = {
    ...
    latitude: data.latitude || (data.customerLocation ? data.customerLocation.lat : null),
    longitude: data.longitude || (data.customerLocation ? data.customerLocation.lng : null),
    customerLocation: data.customerLocation || (data.latitude && data.longitude ? { lat: data.latitude, lng: data.longitude } : null),
